...
List<CurrencyData> getSixMonthsChartData() {
  final List<CurrencyData> chartData = [CurrencyData(1, 15000.30), CurrencyData(2, 10000.0), CurrencyData(3, 70000.1), CurrencyData(4, 30000.3), CurrencyData(5, 35000.0), CurrencyData(6, 33000.0)];
  return chartData;
}
